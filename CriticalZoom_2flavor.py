...
def allSigmas(args):#,mu,ml,minsigma,maxsigma,a0,lambda1):
    ...
    "Matching Fang paper"
    v4=4.2
    "v3=0 is 2-flavor, i.e. strange quark mass is infinite"
...
if __name__ == '__main__':
    ...
    df_all.to_pickle('data/chiral_transition_2flavor_mq%i_mu%i_lambda1%f_order%i.pkl' %(ml,mu,lambda1,order))
